...
var Movie = function Movie(props) {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        "a",
        { href: "https://www.imdb.com/title/" + imdbID + "/", target: "blank" },
...
var MovieFinder = function (_React$Component) {
  ...
  _createClass(MovieFinder, [{
    ...
    value: function handleSubmit(event) {
      ...
      fetch("https://www.omdbapi.com/?s=" + searchTerm + "&apikey=cfc0954c").then(checkStatus).then(json).then(function (data) {
